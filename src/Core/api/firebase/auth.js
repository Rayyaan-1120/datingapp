  ...
  return new Promise((resolve, _reject) => {
    auth()
      ...
      .then(response => {
        ...
        console.log(first_name, last_name, family_name, given_name,'abcd')
        const { uid, email, phoneNumber, photoURL } = response.user
        console.log(uid, email, phoneNumber, photoURL,'abcdefghijk')
            ...
            .then(() => {
              resolve({
                user: { id: uid,
                  ...
                  userID: uid,
                  appIdentifier,
                  createdAt: timestamp, id: uid, userID: uid },
                accountCreated: true,
              })
            })
        }
...
export const loginWithGoogle = (idToken, appIdentifier) => {
  ...
  return new Promise((resolve, _reject) => {
    signInWithCredential(credential, appIdentifier).then(response => {
      console.log(response,'I am firebase response');
      resolve(response)
    })
  })
}
